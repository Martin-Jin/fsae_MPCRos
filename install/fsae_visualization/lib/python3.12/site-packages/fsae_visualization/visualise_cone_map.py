...
class ConePublisher(Node):
    def __init__(self):
        ...
        self.markers_publisher_ = self.create_publisher(MarkerArray, '/fsae/viz/cones', 10)
        self.localization_marker_publisher = self.create_publisher(MarkerArray, '/fsae/viz/car', 10)
        # ego transform now broadcast on /tf (was a TransformStamped on the 'base_tf' topic)
        self.tf_broadcaster = TransformBroadcaster(self)
        self.detections_publisher = self.create_publisher(MarkerArray, '/fsae/viz/detections', 10)


        self.detections_subscriber = self.create_subscription(ConeDetection, '/fsae/perception/cone_detection', self.detections_callback, 10)
        ...
        self.subscription_localization = self.create_subscription(Pose, '/fsae/slam/car_position', self.localization_callback, 10)
