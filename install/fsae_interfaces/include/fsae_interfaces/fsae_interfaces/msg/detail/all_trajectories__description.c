  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x1d, 0x35, 0xe6, 0x82, 0x1f, 0x5d, 0x36, 0x1e,
      0x6e, 0xac, 0x6e, 0xcc, 0xfd, 0x08, 0x4a, 0x6e,
      0x8e, 0x0c, 0x14, 0xd4, 0x17, 0x7c, 0x24, 0x38,
      0x96, 0x5e, 0xf5, 0xeb, 0xf9, 0xf0, 0xb6, 0x67,
    }};
  return &hash;
}
...
static char fsae_interfaces__msg__AllTrajectories__TYPE_NAME[] = "fsae_interfaces/msg/AllTrajectories";
...
static char fsae_interfaces__msg__AllTrajectories__FIELD_NAME__id[] = "id";
static char fsae_interfaces__msg__AllTrajectories__FIELD_NAME__trajectories[] = "trajectories";

static rosidl_runtime_c__type_description__Field fsae_interfaces__msg__AllTrajectories__FIELDS[] = {
  {
    {fsae_interfaces__msg__AllTrajectories__FIELD_NAME__id, 2, 2},
    {
  ...
  {
    {fsae_interfaces__msg__AllTrajectories__FIELD_NAME__trajectories, 12, 12},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription fsae_interfaces__msg__AllTrajectories__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {fsae_interfaces__msg__AllTrajectories__TYPE_NAME, 35, 35},
      {fsae_interfaces__msg__AllTrajectories__FIELDS, 2, 2},
    },
    {fsae_interfaces__msg__AllTrajectories__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *fsae_interfaces__msg__AllTrajectories__get_individual_type_description_source(NULL),
