...
class FasttubeWithoutKalman(Node):
    def __init__(self):
        super().__init__("fasttube_without_kalman")
        ...
        # subscribers
        self.subscription_cone_detection = self.create_subscription(ConeDetection, '/fsae/perception/cone_detection', self.cone_detection_callback, 10)
    ...
    def cone_detection_callback(self, msg: ConeDetection) -> None:
