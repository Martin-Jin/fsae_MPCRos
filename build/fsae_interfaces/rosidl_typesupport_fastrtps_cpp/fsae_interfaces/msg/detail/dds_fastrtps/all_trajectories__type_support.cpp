...
#include "fsae_interfaces/msg/detail/all_trajectories__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fsae_interfaces::msg::AllTrajectories & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fsae_interfaces::msg::AllTrajectories & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_fsae_interfaces
max_serialized_size_AllTrajectories(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fsae_interfaces::msg::AllTrajectories;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_fsae_interfaces
max_serialized_size_key_AllTrajectories(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const fsae_interfaces::msg::AllTrajectories *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fsae_interfaces::msg::AllTrajectories *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AllTrajectories__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fsae_interfaces::msg::AllTrajectories *>(
...
static size_t _AllTrajectories__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AllTrajectories(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AllTrajectories__callbacks = {
  "fsae_interfaces::msg",
  "AllTrajectories",
...
static rosidl_message_type_support_t _AllTrajectories__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AllTrajectories__callbacks,
...
{
  return &fsae_interfaces::msg::typesupport_fastrtps_cpp::_AllTrajectories__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fsae_interfaces, msg, AllTrajectories)() {
  return &fsae_interfaces::msg::typesupport_fastrtps_cpp::_AllTrajectories__handle;
}
