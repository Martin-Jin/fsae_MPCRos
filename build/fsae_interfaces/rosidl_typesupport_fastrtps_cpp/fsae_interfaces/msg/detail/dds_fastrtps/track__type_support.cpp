...
#include "fsae_interfaces/msg/detail/track__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fsae_interfaces::msg::Track & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fsae_interfaces::msg::Track & ros_message)
{
  // Member: cones
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fsae_interfaces::msg::Track;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fsae_interfaces::msg::Track *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fsae_interfaces::msg::Track *>(
    untyped_ros_message);
...
{
  return &fsae_interfaces::msg::typesupport_fastrtps_cpp::_Track__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fsae_interfaces, msg, Track)() {
  return &fsae_interfaces::msg::typesupport_fastrtps_cpp::_Track__handle;
}
