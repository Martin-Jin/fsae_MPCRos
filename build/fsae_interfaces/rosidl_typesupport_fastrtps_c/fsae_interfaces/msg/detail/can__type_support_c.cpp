...
#include "fsae_interfaces/msg/detail/can__rosidl_typesupport_fastrtps_c.h"
...
using _CAN__ros_msg_type = fsae_interfaces__msg__CAN;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fsae_interfaces__msg__CAN;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const fsae_interfaces__msg__CAN * ros_message = static_cast<const fsae_interfaces__msg__CAN *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_fsae_interfaces__msg__CAN(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  fsae_interfaces__msg__CAN * ros_message = static_cast<fsae_interfaces__msg__CAN *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_fsae_interfaces__msg__CAN(cdr, ros_message);
}

static uint32_t _CAN__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fsae_interfaces__msg__CAN(
...
static size_t _CAN__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fsae_interfaces__msg__CAN(
