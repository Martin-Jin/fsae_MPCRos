...
bool fsae_interfaces__msg__track__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fsae_interfaces.msg._track.Track", full_classname_dest, 32) == 0);
  }
  fsae_interfaces__msg__Track * ros_message = _ros_message;
  {  // cones
    ...
    geometry_msgs__msg__Point * dest = ros_message->cones.data;
...
PyObject * fsae_interfaces__msg__track__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("fsae_interfaces.msg._track");
