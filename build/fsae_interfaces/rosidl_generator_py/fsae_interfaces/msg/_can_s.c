...
bool fsae_interfaces__msg__can__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fsae_interfaces.msg._can.CAN", full_classname_dest, 28) == 0);
  }
  fsae_interfaces__msg__CAN * ros_message = _ros_message;
  {  // id
...
PyObject * fsae_interfaces__msg__can__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("fsae_interfaces.msg._can");
