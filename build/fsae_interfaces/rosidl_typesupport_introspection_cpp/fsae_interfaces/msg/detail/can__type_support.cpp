...
{
  new (message_memory) fsae_interfaces::msg::CAN(_init);
}

void CAN_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fsae_interfaces::msg::CAN *>(message_memory);
  typed_message->~CAN();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CAN_message_member_array[3] = {
  {
    "id",  // name
    ...
    offsetof(fsae_interfaces::msg::CAN, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fsae_interfaces::msg::CAN, is_rtr),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    8,  // array size
    false,  // is upper bound
    offsetof(fsae_interfaces::msg::CAN, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CAN_message_members = {
  ...
  "CAN",  // message name
  3,  // number of fields
  sizeof(fsae_interfaces::msg::CAN),
...
{
  return &::fsae_interfaces::msg::rosidl_typesupport_introspection_cpp::CAN_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fsae_interfaces, msg, CAN)() {
  return &::fsae_interfaces::msg::rosidl_typesupport_introspection_cpp::CAN_message_type_support_handle;
}
